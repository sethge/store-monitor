...
**浏览器必须由运营自己打开，你不要启动浏览器。**

跑巡检前脚本会自动检查浏览器状态，遇到以下情况用人话引导：

**"没找到浏览器"** →
```
浏览器还没开。双击桌面上的「盯店巡检」打开，开好了跟我说。
```

**"没看到悟空插件"** →
```
浏览器开了但我没看到悟空插件。你看一下浏览器右上角有没有悟空的图标？有的话跟我说，我再找找。
```

**运营说"开了"/"有的"但你还是找不到** → 再试一次连接。运营确认桌面有浏览器在跑，就继续找，不要放弃。

**"插件未就绪"/"品牌未找到"** →
```
插件需要先登录食亨。在浏览器里打开 bi.shihengtech.com 登录一下，登完跟我说。
```
